...
$is_login = isset($_SESSION['id_user']) || isset($_SESSION['user_id']);
        ...
        <div class="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            ...
            <div class="space-y-5 md:space-y-7 animate-fade text-center lg:text-left order-2 lg:order-1">
                ...
                <div class="pt-2 flex justify-center lg:justify-start">
                    ...
                    <a href="<?= $is_login ? 'user/booking.php' : 'login.php'; ?>" class="btn-pink inline-block px-9 py-4 rounded-full font-bold tracking-widest text-xs md:text-sm shadow-lg uppercase">
                        Booking Sekarang
                    </a>
                </div>
            </div>
                            ...
                            <article class="product-card product-slide-in theme-card rounded-[24px] overflow-hidden shadow-md border flex-shrink-0 snap-start" style="animation-delay: <?= $index * 0.08; ?>s">
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                        ...
                                        <!-- Link booking -->
                                        <a href="<?= $is_login ? 'user/booking.php' : 'login.php'; ?>" class="text-[11px] md:text-xs font-bold text-accent-pink tracking-widest uppercase hover:translate-x-1 transition inline-flex items-center gap-1">
