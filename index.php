...
// Mengambil gambar layanan dari kolom gambar_layanan database
...
<body class="light">
    ...
    <section id="home" class="relative pt-24 md:pt-28 pb-10 px-6 overflow-hidden flex items-center">
        <div class="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            ...
            <div class="relative animate-fade order-1 lg:order-2" style="animation-delay: 0.2s">
                <div class="rounded-[22px] md:rounded-[28px] overflow-hidden shadow-xl border-[6px] border-white dark:border-[#1E1E1E] w-full max-w-[280px] sm:max-w-[320px] md:max-w-[360px] mx-auto">
                    <video class="w-full h-auto object-contain bg-black" autoplay muted loop playsinline preload="metadata">
    ...
    <!-- About section -->
    <section id="about" class="section-compact py-14 md:py-20 bg-white dark:bg-white">
        <div class="max-w-5xl mx-auto px-6">
            <h2 class="text-3xl md:text-4xl font-serif text-center text-dark-brown mb-10 uppercase tracking-widest">Tentang Kami</h2>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-stretch">
                <div class="service-card p-4 rounded-[28px] group bg-white border border-gray-100 shadow-sm">
                    ...
                    <div class="px-3 md:px-4 pb-4 text-center md:text-left">
                        <h3 class="text-xl md:text-2xl font-serif text-dark-brown mb-3">Gaya Rambut yang Bercerita</h3>
                        <p class="text-sm md:text-base text-soft-brown leading-relaxed">Ekspresikan diri lewat gaya rambut yang dirancang khusus sesuai dengan karakter unik.</p>
                    </div>
                </div>
    ...
    <section id="product" class="section-compact py-14 md:py-20 px-6 overflow-hidden bg-white dark:bg-[#121212]">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-10 md:mb-12">
                ...
                <p class="text-soft-brown text-sm md:text-base mt-8 max-w-2xl mx-auto">Pilihan layanan terbaik Mey Salon yang tampil otomatis dari database.</p>
            </div>
            ...
            <?php if (!empty($layananList)): ?>
                <div class="product-slider-wrapper">
                    ...
                    <div id="product-slider" class="product-slider flex gap-5 overflow-x-auto pb-6 px-1 md:px-12 snap-x snap-mandatory">
                        <?php foreach ($layananList as $index => $layanan): ?>
                            <article class="product-card product-slide-in service-card rounded-[24px] overflow-hidden shadow-md border border-gray-100 dark:border-gray-800 flex-shrink-0 bg-white dark:bg-[#181818] snap-start" style="animation-delay: <?= $index * 0.08; ?>s">
                                ...
                                <div class="p-5">
                                    <div class="mb-4">
                                        <h3 class="text-lg md:text-xl font-serif font-bold text-dark-brown leading-snug mb-2 line-clamp-2 min-h-[56px]">
                                    ...
                                    <p class="text-xs md:text-sm text-soft-brown leading-relaxed mb-5 line-clamp-3">Layanan perawatan terbaik dari Mey Salon dengan hasil yang nyaman, rapi, dan profesional.</p>

                                    <div class="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-800">
                                        <span class="text-[11px] text-soft-brown font-semibold">ID: <?= htmlspecialchars($layanan['id_layanan']); ?></span>
                                        <a href="login.php" class="text-[11px] md:text-xs font-bold text-accent-pink tracking-widest uppercase hover:translate-x-1 transition inline-flex items-center gap-1">Booking <span>&rarr;</span></a>
                                    </div>
                                </div>
                            </article>
                        <?php endforeach; ?>
                ...
                <p class="text-center text-xs text-soft-brown mt-2 md:hidden">Geser ke samping untuk melihat layanan lainnya</p>
            <?php else: ?>
                <div class="service-card rounded-[24px] p-8 text-center shadow-md">
                    <p class="text-soft-brown">Data layanan belum tampil. Cek kembali koneksi database dan tabel <strong>layanan</strong>.</p>
                </div>
            <?php endif; ?>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid lg:grid-cols-2 gap-8 md:gap-12 items-stretch">
                ...
                <div class="service-card p-8 md:p-10 rounded-[30px] md:rounded-[36px] shadow-2xl flex flex-col justify-center">
                    ...
                    <p class="text-soft-brown leading-relaxed mb-6">Siap membantu Anda tampil lebih percaya diri dengan berbagai layanan perawatan rambut dan kecantikan terbaik.</p>
                    ...
                    <div class="pt-8">
                        <a href="login.php" class="btn-pink inline-block px-8 py-4 rounded-full font-bold tracking-widest text-xs md:text-sm shadow-lg uppercase">Booking Sekarang</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="bg-[#1A120B] text-white py-10 md:py-14 px-6">
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 md:gap-10">
            ...
            <div class="text-center md:text-right space-y-4">
                <div class="text-gray-500 text-[8px] md:text-[10px] tracking-[3px] md:tracking-[5px] font-bold uppercase">© 2026 MEY SALON. ALL RIGHTS RESERVED.</div>
            </div>
        </div>
    </footer>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            slider.addEventListener('mouseenter', function () { clearInterval(productAutoSlide); });
            slider.addEventListener('mouseleave', function () { productAutoSlide = setInterval(autoSlideProduct, 4000); });
        });
    </script>
