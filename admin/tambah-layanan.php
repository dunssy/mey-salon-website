...
// memanggil fungsi tambah_layanan dari controller.php untuk menambahkan layanan baru ke database
                   ...
                   <a href="data-layanan.php" class="inline-block px-4 py-2 text-sm font-bold text-gray-400 bg-gray-50 rounded-lg hover:bg-pink-50 hover:text-pink-600 transition-colors">
                     ...
                     <form action="" method="POST" class="mb-6 mt-4 p-6 bg-white p-6 rounded-2xl shadow-sm border border-pink-100 ">
                        <div class="mb-4">
                             ...
                             <input type="text" name="nama_layanan" id="nama_layanan" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-200">
                        </div>
                        <div class="mb-4">
                             <label for="harga_layanan" class="block text-sm font-medium text-gray-700 mb-1">Harga Layanan</label>
                             <input type="number" name="harga_layanan" id="harga_layanan" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-200">
                        </div>
                        <div class="mb-4">
                             <label for="durasi_layanan" class="block text-sm font-medium text-gray-700 mb-1">Durasi Layanan </label>
                             <input type="number" name="durasi_layanan" id="durasi_layanan" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-200">
                        </div>
                            <input type="submit" name="submit" class="px-4 py-2 bg-pink-600 text-white font-bold rounded-lg hover:bg-pink-700 transition-colors" value="Tambah Layanan">
                    </form>
            </div>
            <!-- Footer Informatif -->
