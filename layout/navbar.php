...
<header class="bg-white/80 backdrop-blur-md border-b border-pink-100 px-4 md:px-8 py-3 flex justify-between items-center sticky top-0 z-30">
    ...
    <div class="flex items-center gap-4">
        ...
        <button 
            ...
            class="md:hidden w-10 h-10 flex items-center justify-center rounded-xl text-gray-500 hover:bg-pink-50 hover:text-pink-600 transition"
            type="button"
        >
        ...
        <button 
            ...
            class="hidden md:flex w-10 h-10 items-center justify-center rounded-xl text-gray-500 hover:bg-pink-50 hover:text-pink-600 transition"
            type="button"
        >
    ...
    <div class="flex items-center space-x-2 md:space-x-4">
        ...
        <div class="relative">
            <button 
                ...
                class="p-2 text-gray-400 hover:text-pink-600 transition-colors relative"
                type="button"
            >
            ...
            <div id="notif-dropdown" class="hidden absolute right-0 mt-3 w-72 md:w-80 bg-white rounded-2xl shadow-xl border border-pink-50 overflow-hidden z-50">
                ...
                <button class="w-full py-3 bg-pink-50 text-pink-600 text-xs font-bold hover:bg-pink-100" type="button">
        ...
        <div class="relative">
            ...
            <button 
                ...
                class="flex items-center space-x-2 md:space-x-3 cursor-pointer group hover:bg-pink-50 p-1 rounded-xl transition-all"
                type="button"
            >
